        ...
        <div class="topbar">
            ...
            <nav class="navbar-custom">
                <ul class="list-unstyled topbar-nav float-end mb-0">
                    ...
                    <li class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <a class="dropdown-item" href="index.html#"><i data-feather="power"
                ...
                <ul class="list-unstyled topbar-nav mb-0">
                    ...
                    <li class="creat-btn">
                        <div class="nav-link">
                            <a class=" btn btn-sm btn-soft-primary" href="index.html#" role="button"><i
                        ...
                        <div class="page-title-box">
                            <div class="row">
                                ...
                                <div class="col-auto align-self-center">
                                    <a href="index.html#" class="btn btn-sm btn-outline-primary" id="Dash_Date">
                                ...
                                <ul class="list-group custom-list-group mb-n3">
                                    <li class="list-group-item align-items-center d-flex justify-content-between pt-0">
                                        ...
                                        <div class="align-self-center">
                                            <a href="index.html" class="btn btn-sm btn-soft-primary">4.3k <i
                                    ...
                                    <li class="list-group-item align-items-center d-flex justify-content-between">
                                        ...
                                        <div class="align-self-center">
                                            <a href="index.html" class="btn btn-sm btn-soft-primary">3.7k <i
                                                    class="las la-external-link-alt font-15"></i></a>
                                        </div>
                                    </li>
                                    <li class="list-group-item align-items-center d-flex justify-content-between">
                                        ...
                                        <div class="align-self-center">
                                            <a href="index.html" class="btn btn-sm btn-soft-primary">2.9k <i
                                                    class="las la-external-link-alt font-15"></i></a>
                                        </div>
                                    </li>
                                    <li class="list-group-item align-items-center d-flex justify-content-between">
                                        ...
                                        <div class="align-self-center">
                                            <a href="index.html" class="btn btn-sm btn-soft-primary">1.6k <i
                                                    class="las la-external-link-alt font-15"></i></a>
                                        </div>
                                    </li>
                                </ul>
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="d-block ms-2 align-self-center">
                                        ...
                                        <p class="mb-0 text-muted">It is a long established fact that a reader will
                                            ...
                                            <a href="index.html" class="text-primary">Read More <i
                                            ...
                                            <div class="activity-info-text">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <p class="text-muted mb-0 font-13 w-75"><span>Donald</span>
                                                        updated the status of <a href="index.html">Refund #1234</a> to
                                            ...
                                            <div class="activity-info-text">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <p class="text-muted mb-0 font-13 w-75"><span>Joseph Rust</span>
                                                        opened new showcase <a href="index.html">Mannat #112233</a>
                                                        with theme market
                                                    </p>
                                ...
                                <div class="table-responsive browser_users">
                                    <table class="table mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <!--end tr-->
                                            <tr>
                                                <td><img src="assets/images/browser_logo/micro-edge.png"
                                                        alt="" height="16" class="me-2">Microsoft Edge
                                                </td>
                                                <td>2545<small class="text-muted">(47%)</small></td>
                                                <td> 47.54%</td>
                                                <td>498<small class="text-muted">(81%)</small></td>
                                            ...
                                            <!--end tr-->
                                            <tr>
                                                <td><img src="assets/images/browser_logo/in-explorer.png"
                                                        alt="" height="16"
